      ...
      >
        ...
        >
          {expertise.map((skill, index) => (
            ...
            >
              ...
              {/* Main content card */}
              <div className="relative p-6 sm:p-8 rounded-2xl bg-white dark:bg-dark-100 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-dark-300 flex-1">
                {/* Animated background elements */}
                <motion.div 
                  className="absolute top-0 right-0 w-32 h-32 -mr-16 -mt-16 bg-primary-500/10 rounded-full blur-2xl"
                  animate={{
                    scale: [1, 1.2, 1],
                    rotate: [0, 90, 0],
                  }}
                ...
                <div className="relative z-10">
                  <motion.div 
                    className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center mb-4"
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold mb-4 group-hover:text-primary-500 transition-colors duration-300">
                    {skill.title}
                  </h3>
                ...
                >
                  ...
                  >
                    <div className="group relative">
                      ...
                      <div className="relative p-6 sm:p-8 rounded-2xl bg-white dark:bg-dark-100 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-dark-300">
                        <motion.div 
                          className="absolute top-0 right-0 w-24 h-24 -mr-12 -mt-12 bg-primary-500/10 rounded-full blur-2xl"
                          animate={{
                            scale: [1, 1.2, 1],
                            rotate: [0, 90, 0],
                          }}
                        ...
                        <div className="relative z-10">
                          <motion.span 
                            className="inline-block px-4 py-2 rounded-full text-sm font-medium bg-primary-500/10 text-primary-500 mb-4"
                            whileHover={{ scale: 1.1 }}
                          >
                            {exp.period}
                          </motion.span>
                          
                          <h4 className="text-xl sm:text-2xl font-bold mb-2 group-hover:text-primary-500 transition-colors duration-300">
                            {exp.role}
                          </h4>
                          
                          <h5 className="text-lg sm:text-xl font-medium text-primary-500 mb-4">
                            {exp.company}
                          </h5>
        ...
        <motion.div variants={itemVariants} className="text-center mb-8 md:mb-32 px-2 sm:px-6">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <motion.div 
              className="bg-white dark:bg-dark-100 rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl mb-12 transform hover:scale-[1.02] transition-all duration-300 relative overflow-hidden"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4 }}
            >
              ...
              <div className="relative z-10">
                <h4 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 text-primary-500">Research Excellence in Boracay</h4>
                <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                  ...
                  <div className="relative rounded-2xl overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-6">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <h4 className="text-2xl font-bold text-white">{selectedImage.title}</h4>
                      </div>
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                  {[
                    ...
                    <motion.div
                      key={index}
                      className={`bg-gradient-to-br ${achievement.color} rounded-2xl p-6 backdrop-blur-sm border border-white/10`}
                      whileHover={{ scale: 1.05, y: -5 }}
                      transition={{ duration: 0.3 }}
                    >
                      <span className="text-4xl mb-4 block">{achievement.icon}</span>
                      <h5 className="text-xl font-bold mb-2">{achievement.title}</h5>
