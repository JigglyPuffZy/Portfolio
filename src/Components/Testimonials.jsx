...
const Testimonials = () => {
  return (
    <section id="testimonials" className="min-h-[40vh] py-20 bg-gradient-to-br from-primary-50 via-white to-primary-100 dark:from-slate-900 dark:via-primary-950 dark:to-slate-900">
      <div className="max-w-3xl mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 text-primary-900 dark:text-primary-100">Testimonials</h2>
        <div className="flex gap-6 overflow-x-auto pb-4">
          {testimonials.map((t, idx) => (
            <div key={idx} className="min-w-[250px] bg-white/80 dark:bg-slate-800/80 rounded-xl shadow p-6 flex flex-col items-center">
              <span className="text-lg font-semibold text-primary-700 dark:text-primary-300 mb-2">{t.name}</span>
